A computer network is a group of two or more computers or other computing devices (like smartphones, tablets, printers, etc.) that are connected together to share resources and communicate with each other.
